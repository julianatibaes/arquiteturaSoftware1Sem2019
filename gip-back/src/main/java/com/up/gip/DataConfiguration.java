...
public class DataConfiguration{
	    ...
	    public DataSource dataSource(){
			 ...
			 * 3306 - porta do mysql
			 * gip_db - nome do banco
			 * localhost - endereço do banco de dados
			 */
	        dataSource.setUrl("jdbc:mysql://localhost:3306/gip_db");
	     	// nome de usuário do banco de dados onde root corresponde ao nome de usuário do banco de dados
		...
		public JpaVendorAdapter jpaVendorAdapter(){
			...
			// versão antiga adapter.setDatabasePlatform("org.hibernate.dialect.MySQLDialect");
